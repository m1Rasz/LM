function renderOffer(oferta) {
    ...
    detailsContainer.innerHTML += `<h3>Szczegóły konta</h3>`;
    ...
    paymentContainer.innerHTML = `<strong>Metody płatności</strong>`;
...
function loadOfferDetails() {
    ...
    fetch('strony.json')
        ...
        .catch(error => console.error('Błąd przy wczytywaniu oferty:', error));
}
